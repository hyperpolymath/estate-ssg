...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/estate-ssg/security/advisories/new)
...
- This repository (`hyperpolymath/estate-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/estate-ssg/security/advisories)
...
When using estate-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/estate-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/estate-ssg/security/advisories/new) or security@hyperpolymath.org |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/estate-ssg/discussions) |
...
*Thank you for helping keep estate-ssg and its users safe.*
